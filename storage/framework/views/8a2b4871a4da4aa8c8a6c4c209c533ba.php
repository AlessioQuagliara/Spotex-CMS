    ...
    <div class="max-w-md w-full space-y-8">
        <div>
            ...
            <p class="mt-2 text-center text-sm" style="color: <?php echo e($theme['muted'] ?? '#6b7280'); ?>;">
                Oppure
                <a href="<?php echo e(route('register')); ?>" class="font-medium hover:opacity-80" style="color: <?php echo e($theme['primary'] ?? '#3b82f6'); ?>;">
        ...
        <form class="mt-8 space-y-6" action="<?php echo e(route('login.post')); ?>" method="POST">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    >
                    <label for="remember" class="ml-2 block text-sm" style="color: <?php echo e($theme['text'] ?? '#1f2937'); ?>;">
                        Ricordami
                    </label>
                </div>

                <div class="text-sm">
                    <a href="#" class="font-medium hover:opacity-80" style="color: <?php echo e($theme['primary'] ?? '#3b82f6'); ?>;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/alessio/Progetti/Spotex-SRL/Spotex-CMS/resources/views/auth/login.blade.php ENDPATH**/ ?>