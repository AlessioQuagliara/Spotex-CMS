...
<head>
    ...
    <title><?php echo e($page->title); ?> - Advanced Page Builder</title>
...
const CUSTOM_BLOCKS =  <?php echo json_encode($themeBlocks, 15, 512) ?> ;
...
const INITIAL_ELEMENTS = <?php echo json_encode($builderData, 15, 512) ?>;
const PAGE_SLUG = <?php echo json_encode($page->slug, 15, 512) ?>;
const PAGE_TITLE = <?php echo json_encode($page->title, 15, 512) ?>;
const PAGE_ID = <?php echo json_encode($page->id, 15, 512) ?>;
...
</html><?php /**PATH /Users/alessio/Progetti/Spotex-SRL/Spotex-CMS/resources/views/builder/index.blade.php ENDPATH**/ ?>