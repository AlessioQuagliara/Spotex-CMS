...
<div class="min-h-screen" style="background-color: <?php echo e($theme['background'] ?? '#f9fafb'); ?>;">
    <div class="container mx-auto px-4 py-8">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-4xl font-bold" style="color: <?php echo e($theme['text'] ?? '#1f2937'); ?>;">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!auth()->user()->hasVerifiedEmail()): ?>
            <div class="mb-8 rounded-lg p-4 border-l-4" style="background-color: #fef3c7; border-color: <?php echo e($theme['primary'] ?? '#f59e0b'); ?>;">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-2" style="color: <?php echo e($theme['primary'] ?? '#3b82f6'); ?>;">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <a href="<?php echo e(route('customer.profile')); ?>" class="block p-4 rounded-lg border-2 text-center hover:shadow-lg transition" style="border-color: <?php echo e($theme['border'] ?? '#e5e7eb'); ?>; hover:border-color: <?php echo e($theme['primary'] ?? '#3b82f6'); ?>;">
                <svg class="w-8 h-8 mx-auto mb-2" style="color: <?php echo e($theme['primary'] ?? '#3b82f6'); ?>" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd" />
                </svg>
                <p class="font-medium">Il mio Profilo</p>
            </a>

            <a href="<?php echo e(route('customer.orders')); ?>" class="block p-4 rounded-lg border-2 text-center hover:shadow-lg transition" style="border-color: <?php echo e($theme['border'] ?? '#e5e7eb'); ?>; hover:border-color: <?php echo e($theme['primary'] ?? '#3b82f6'); ?>;">
                <svg class="w-8 h-8 mx-auto mb-2" style="color: <?php echo e($theme['primary'] ?? '#3b82f6'); ?>" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 6H6.28l-.31-1.243A1 1 0 005 4H3z" />
                    <path d="M16 16a2 2 0 11-4 0 2 2 0 014 0zM4 12a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
            ...
            <a href="<?php echo e(route('customer.addresses')); ?>" class="block p-4 rounded-lg border-2 text-center hover:shadow-lg transition" style="border-color: <?php echo e($theme['border'] ?? '#e5e7eb'); ?>; hover:border-color: <?php echo e($theme['primary'] ?? '#3b82f6'); ?>;">
                <svg class="w-8 h-8 mx-auto mb-2" style="color: <?php echo e($theme['primary'] ?? '#3b82f6'); ?>" fill="currentColor" viewBox="0 0 20 20">
            ...
            <form method="POST" action="<?php echo e(route('logout')); ?>" class="block">
                <?php echo csrf_field(); ?>
                <button type="submit" class="w-full p-4 rounded-lg border-2 text-center hover:shadow-lg transition text-red-600" style="border-color: <?php echo e($theme['border'] ?? '#e5e7eb'); ?>;">
        ...
        <div class="bg-white rounded-lg shadow">
            <div class="px-6 py-4 border-b">
                <h2 class="text-2xl font-bold" style="color: <?php echo e($theme['text'] ?? '#1f2937'); ?>;">
                    Ordini Recenti
                </h2>
            </div>
            ...
            <div class="overflow-x-auto">
                        ...
                        <tbody class="divide-y">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 text-sm font-medium text-gray-900">#<?php echo e($order->id); ?></td>
                                    ...
                                    <td class="px-6 py-4 text-sm">
                                        <span class="px-3 py-1 rounded-full text-xs font-medium <?php echo e($order->payment_status === 'paid' ? 'bg-green-100 text-green-800' :
                                    ...
                                    <td class="px-6 py-4 text-sm">
                                        <span class="px-3 py-1 rounded-full text-xs font-medium <?php echo e($order->shipping_status === 'delivered' ? 'bg-green-100 text-green-800' :
                                            ($order->shipping_status === 'shipped' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800')); ?>">
                                            <?php echo e(ucfirst(str_replace('_', ' ', $order->shipping_status))); ?>

                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-sm">
                                        <a href="<?php echo e(route('customer.orders.show', $order)); ?>" class="font-medium hover:opacity-80" style="color: <?php echo e($theme['primary'] ?? '#3b82f6'); ?>;">
                                            Dettagli
                                        </a>
                                    </td>
                                </tr>
                ...
                <?php else: ?>
                    <div class="px-6 py-12 text-center">
                        ...
                        <a href="<?php echo e(route('products')); ?>" class="inline-block mt-4 font-medium hover:opacity-80" style="color: <?php echo e($theme['primary'] ?? '#3b82f6'); ?>;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/alessio/Progetti/Spotex-SRL/Spotex-CMS/resources/views/customer/dashboard.blade.php ENDPATH**/ ?>