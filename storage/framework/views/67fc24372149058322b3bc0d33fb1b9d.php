    ...
    <div class="bg-gray-50 text-slate-900 py-16 border-b border-gray-200">
        <div class="container mx-auto px-4">
            <h1 class="text-4xl font-bold">
                <?php echo e(isset($selectedCategory) && $selectedCategory ? $selectedCategory->name : 'Prodotti'); ?>

            </h1>
            <p class="text-lg text-slate-600 mt-2">
                <?php echo e(isset($selectedCategory) && $selectedCategory ? 'Prodotti nella categoria' : 'Catalogo prodotti'); ?>
    ...
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="mb-12">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                ?>
                <a href="<?php echo e(route('products')); ?>" class="<?php echo e($isAllActive ? 'bg-slate-900 text-white hover:bg-slate-800' : 'bg-white border border-gray-300 text-slate-800 hover:border-slate-500'); ?> font-semibold py-3 px-4 rounded text-center transition">
                    Tutti
                </a>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    <a href="<?php echo e(route('category.show', $category)); ?>" class="<?php echo e($isActive ? 'bg-slate-900 text-white hover:bg-slate-800' : 'bg-white border border-gray-300 text-slate-800 hover:border-slate-500'); ?> font-semibold py-3 px-4 rounded text-center transition">
