...
<div class="min-h-screen" style="background-color: <?php echo e($theme['background'] ?? '#f9fafb'); ?>;">
    <div class="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <form method="POST" action="<?php echo e(route('customer.addresses.store')); ?>" class="bg-white rounded-lg shadow p-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-4 mb-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="country" value="<?php echo e(old('country', 'IT')); ?>" required
                            class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2" 
                            style="focus:ring-color: <?php echo e($theme['primary'] ?? '#3b82f6'); ?>; focus:border-color: <?php echo e($theme['primary'] ?? '#3b82f6'); ?>;"
                            placeholder="IT"
                            maxlength="2"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/alessio/Progetti/Spotex-SRL/Spotex-CMS/resources/views/customer/addresses/create.blade.php ENDPATH**/ ?>