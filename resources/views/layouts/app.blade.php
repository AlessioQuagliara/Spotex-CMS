    ...
    <nav class="bg-[#010f20] text-white shadow-lg">
        <div class="container mx-auto px-4 py-4 flex items-center justify-between">
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('home') }}" class="text-xl font-bold hover:text-blue-300 transition">SPOTEX</a>
            </div>

            <div class="flex items-center gap-6">
                <a href="{{ route('products') }}" class="hover:text-blue-300 transition">Prodotti</a>
                ...
                @auth
                    ...
                    <a href="{{ route('cart.show') }}" class="flex items-center gap-2 hover:text-blue-300 transition">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        <li><a href="{{ route('products') }}" class="hover:text-white transition">Prodotti</a></li>
                    </ul>
                </div>
