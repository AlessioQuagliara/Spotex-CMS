...
const passwordRequirements = [
  { label: 'Almeno 8 caratteri', key: 'length' },
  { label: 'Almeno una lettera maiuscola', key: 'uppercase' },
  { label: 'Almeno una lettera minuscola', key: 'lowercase' },
  { label: 'Almeno un numero', key: 'number' },
  { label: 'Almeno un carattere speciale', key: 'special' },
]
...
export default function RegisterPage() {
  ...
  // Valida password in tempo reale
        ...
        <CardHeader className="space-y-1">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Registrati per accedere al pannello di amministrazione
              </CardDescription>
            </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Opzionale - apparirà sui tuoi post
              </p>
            </div>
